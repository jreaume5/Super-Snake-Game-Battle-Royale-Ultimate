import pygame
import sys
import random  # it is the module for system
...
snake_icon = pygame.image.load("./images/game.png")
# for some reason this is not working on the mac os... I tried everything like checked on google and all
pygame.display.set_icon(snake_icon)


width = 400
height = 500
# this just set the display to 400 x 500 pixels
...
# left, top, width, height  ||| creating snake rectange as snake body
snake = pygame.Rect(snakeX, snakeY, snake_size, snake_size)
...
game_over_text = game_over_font.render(
    "Game Over", True, (255, 255, 255))  # text with white color

# we need font for the score
score_font = pygame.font.Font(None, 35)
# we have text "Final Score: " wiht the score
score_text = score_font.render(
    "Final Score: " + str(score), True, (255, 255, 255))
